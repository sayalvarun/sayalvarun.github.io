$(document).ready(function(){
    ...
    var waypoint = new Waypoint({
      ...
      handler: function(direction) {
        $(".subEd").each(function(index){

            $(this).delay(800*index).fadeTo(1000,1,function(){    
                if(numToDisplay==0)
                    startGrad();
...
function init() {
    ...
    renderer.setSize( (1500/window.innerWidth)*window.innerWidth, (1500/window.innerHeight)*window.innerHeight);
